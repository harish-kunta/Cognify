...
public class Constants {
    ...
    public static final long WORD_DASH_DURATION_MS = 60000;
    public static final int DEFAULT_STREAK = 6;
    ...
    public static final String GAME_TYPE_DAILY_WORD_DASH = "daily_word_dash";
